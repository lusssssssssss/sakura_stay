...
public class MemberSuccessView extends JFrame {
    CustomButton back_button;
    Model model;
    Connection con;
    public MemberSuccessView(Model model, Connection con) {
        this.model = model;
        this.con = con;
        this.setTitle("Member Success");
        ...
        MemberCustomPanel outer_panel = new MemberCustomPanel();
        ...
        MemberCustomPanel main_panel = new MemberCustomPanel();
        ...
        JLabel message1 = new JLabel("Thank you for being a member in our hotel,");
        ...
        JLabel message2 = new JLabel("we hope you enjoy this hotel.");
        ...
        message_panel.add(Box.createVerticalStrut(50));
        JLabel message3 = new JLabel("\uD83D\uDCE9 A confirmation email with your ");
        ...
        JLabel message4 = new JLabel("Members details has been sent to you.");
        ...
        JLabel message5 = new JLabel("We look forward to hosting you at Sakura Stay!\n");
        ...
        back_button.addActionListener(e->{
            MemberSuccessView.this.dispose();
            AreYouMemberView view = new AreYouMemberView(model, con);
